...
class SignUpChainOwner extends StatefulWidget {
  SignUpChainOwner({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SignUpChainOwnerState createState() => _SignUpChainOwnerState();
}

class _SignUpChainOwnerState extends State<SignUpChainOwner> {
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Hero(tag: "chain", child: Image(image: AssetImage('assets/images/chain.png'), height: 250, width: 300,)),
            ),
            SizedBox(height: 20),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Center(child: Text("Are you a shop chain owner?", style: TextStyle(fontSize: 24, fontFamily: AppFontFamilies.mainFont))),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Center(child: Text("Sign up as a shop chain owner!", style: TextStyle(fontFamily: AppFontFamilies.mainFont))),
            ),
            Divider(),
            Padding(
